...
class ImportOrder(models.Model):
	...
	AB_file = models.ImageField(blank=True, null=True)
	VAITEK_order = models.CharField(max_length=128, blank=True)
	VAITEK_payment = models.ImageField(blank=True, null=True)
	bill = models.ImageField(blank=True, null=True)
	TTN = models.ImageField(blank=True, null=True)
